...
function MapUpdater({ sensorPos, targetPositions, fovCone }) {
  ...
  // Handle viewport resize - invalidate map size
  useEffect(() => {
...
export function Map({ klvData, sensors }) {
  ...
  // Calculate FOV cone showing camera orientation
  // Same as real app: absolute azimuth = platformHeading + sensorRelativeAzimuth
