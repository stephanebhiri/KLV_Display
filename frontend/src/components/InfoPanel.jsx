  ...
  const SensorColumn = ({ sensorId, sensorData, color }) => (
    <div className="sensor-column" style={{ borderTopColor: color }}>
      ...
      <div className="sensor-data">
        ...
        <div className="data-group">
          <div className="data-label">Sensor</div>
          <div className="data-row">
            <span>Az</span>
          ...
          <div className="data-row">
            <span>Roll</span>
            <span>{formatDeg(sensorData?.sensor?.roll)}</span>
          </div>
          <div className="data-row">
            <span>HFOV</span>
          ...
          <div className="data-row">
            <span>VFOV</span>
            <span>{formatDeg(sensorData?.sensor?.vfov)}</span>
          </div>
        </div>
        ...
        <div className="data-group">
          ...
          {sensorData?.target?.groundRange && (
            <div className="data-row">
              <span>Ground</span>
              <span>{formatAlt(sensorData.target.groundRange)}</span>
            </div>
          )}
        </div>
      </div>
        ...
        <div className="info-section compact">
          ...
          <div className="platform-row">
            ...
            <div>
              ...
              <span className="value">{formatDeg(klvData?.platform?.pitch)}</span>
            </div>
            <div>
              <span className="label">Roll</span>
              <span className="value">{formatDeg(klvData?.platform?.roll)}</span>
            </div>
          </div>
          <div className="platform-row">
            <div>
              <span className="label">GS</span>
              <span className="value">{klvData?.platform?.groundSpeed != null ? `${klvData.platform.groundSpeed} m/s` : '--'}</span>
            </div>
            <div>
              <span className="label">TAS</span>
              <span className="value">{klvData?.platform?.trueAirspeed != null ? `${klvData.platform.trueAirspeed} m/s` : '--'}</span>
            </div>
          </div>
        </div>
      </div>
